const Footer = () => {
  return (
    <div>
      <footer className="footer bg-gray-300 p-10 bg-base-200 text-base-content flex justify-between items-center border-b border-gray-400">
        <nav>
      ...
      <footer className="footer bg-gray-300 flex justify-between items-center px-10 py-4  bg-base-200 text-base-content border-base-300">
        <div>
